...
<#if parameters.headerKey?exists && parameters.headerValue?exists>
	<#assign hdivValue = dataComposer.compose(parameters.name?default("")?html, "${parameters.headerKey?html}", false)/><#rt/>
    <option value="${hdivValue}"
...
<@s.iterator value="parameters.list">
   	...
   	<#assign hdivValue = dataComposer.compose(parameters.name?default("")?html, "${itemKeyStr?html}", false)/><#rt/>

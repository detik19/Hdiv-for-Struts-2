...
public class SpringMVCMultipartConfig implements IMultipartConfig {
	...
	public void handleMultipartRequest(RequestWrapper request, ServletContext servletContext)
			throws FileUploadException, FileUploadBase.SizeLimitExceededException, MaxUploadSizeExceededException {
	 ...
	 * @param fileItem The file item for the parameter to add
	...
	/**
	 * @param multipartResolver the multipart resolver to set
	 */
	...
	protected String getDefaultEncoding() {
		...
		String encoding = this.multipartResolver.getFileUpload().getHeaderEncoding();
		if (encoding == null) {
	...
	protected FileUpload prepareFileUpload(String encoding) {
		...
		if (encoding != null && !encoding.equals(fileUpload.getHeaderEncoding())) {
			actualFileUpload = newFileUpload(this.multipartResolver.getFileItemFactory());

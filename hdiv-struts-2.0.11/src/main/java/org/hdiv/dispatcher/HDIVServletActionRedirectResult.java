 ...
 * @since HDIV 2.0
 */
public class HDIVServletActionRedirectResult extends HDIVServletRedirectResult {

	private static final long serialVersionUID = 6174439977001844695L;
    ...
    public HDIVServletActionRedirectResult(String actionName) {
        this(null, actionName, null);
    }

    public HDIVServletActionRedirectResult(String actionName, String method) {
        this(null, actionName, method);
    }

    public HDIVServletActionRedirectResult(String namespace, String actionName, String method) {
        super(null);
     ...
     */
    public HDIVServletActionRedirectResult addParameter(String key, Object value) {

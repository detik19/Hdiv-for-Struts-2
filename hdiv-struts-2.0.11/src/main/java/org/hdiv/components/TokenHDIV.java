 ...
 * @since HDIV 2.0.4
 */
@StrutsTag(name="token", tldTagClass="org.hdiv.views.jsp.ui.TokenTagHDIV", description="Stop double-submission of forms")
public class TokenHDIV extends Token {

    public static final String TEMPLATE = "tokenHDIV";
    
    private static final String DATA_COMPOSER = "dataComposer";

    public TokenHDIV(ValueStack stack, HttpServletRequest request, HttpServletResponse response) {

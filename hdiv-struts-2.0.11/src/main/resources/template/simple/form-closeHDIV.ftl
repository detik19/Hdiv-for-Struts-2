<#assign hdivAddedParameters = parameters.hdivParameters.keySet() />
<#list hdivAddedParameters as hdivAddedParameter>
	<#assign hdivParameterValue = parameters.hdivParameters.get(hdivAddedParameter)/>
	<input type="hidden" name="${hdivAddedParameter}" value="${hdivParameterValue}" />
</#list>
</form>
